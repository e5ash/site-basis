...
// Mobile
var mobileBtn = $('.mobile-btn-nav'),
    mobileNav = $('.mobile-nav'),
    panel = $('.panel'),
    mobileClose = $('.mobile-nav__close');
...
$(".footer__form-phone").mask("+7 (999) 999-99-99");
$(".feedback__phone").mask("+7 (999) 999-99-99");

$('.mobile-nav li a + ul').each(function() {
    var ul = $(this),
        parent = ul.parent(),
...
$('.mobile-nav__list > ul > li > a').click(function() {
    var link = $(this),
        ul = link.siblings('ul');
